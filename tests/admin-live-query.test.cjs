...
test('amount ranges are disjoint at every boundary and conserve each direction/currency/hour/status without changing exact buckets',async()=>rollback(async()=>{
  const cases=[
    ...
    ['100','100–200'],['199.999','100–200'],['200','100–200'],['200.001','201–300'],['299.999','201–300'],['300','201–300'],
    ['300.001','301–400'],['399.999','301–400'],['400','301–400'],['400.001','401–500'],['499.999','401–500'],['500','401–500'],
    ['500.001','501–750'],['749.999','501–750'],['750','501–750'],['750.001','751–1,000'],['999.999','751–1,000'],['1000','751–1,000'],
    ['1000.001','1,001–2,000'],['1999.999','1,001–2,000'],['2000','1,001–2,000'],['2000.001','2,001–5,000'],['4999.999','2,001–5,000'],['5000','2,001–5,000'],['5000.001','≥5,001'],['10000','≥5,001']
  ];
