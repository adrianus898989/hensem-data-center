...
test('published overlay matches every reviewed renderer and style source exactly',()=>{
 ...
 assert.equal(m.exports.newModules,['live-comparison.js','live-reference-layout.js','live-empty-pages.js','live-analysis-drilldown.js','live-pages-reference.js','live-rates-restored.js','live-duration-reference.js','live-payout-config.js','live-filter-controls.js','live-configuration.js','live-provider-aliases.js','live-provider-summary.js','live-provider-orders.js','live-provider-sticky.js','live-collected-data.js','live-report-data.js','live-withdraw-pages.js','live-deposit-issues.js','live-sync-health.js','live-data.js'].map(read).join('\n'));
 assert.equal(m.exports.restoredCss,['live-restored.css','live-reference-pages.css','live-payout-config.css','live-configuration.css','live-sync-health.css','live-analysis-drilldown.css','live-report-data.css'].map(read).join('\n'));
});
