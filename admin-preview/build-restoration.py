...
names = ['live-comparison.js', 'live-reference-layout.js', 'live-empty-pages.js',
         ...
         'live-payout-config.js', 'live-filter-controls.js', 'live-configuration.js', 'live-provider-aliases.js', 'live-provider-summary.js', 'live-provider-orders.js','live-provider-sticky.js', 'live-collected-data.js', 'live-withdraw-pages.js', 'live-deposit-issues.js', 'live-data.js']
